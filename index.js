...
const credentials = new AWS.Credentials({
  accessKeyId: 'AKIAR2DOH4FYHHY3XTDE', // Replace with your AWS_ACCESS_KEY
  secretAccessKey: 'DVDxChed1uTMfGndj7OIKY0s5HaeuzmH0y8cgI1z', // Replace with your AWS_SECRET_KEY
});

const accessKeyId = 'AKIAR2DOH4FYIEYX374P';
const secretAccessKey = 'ezMiaN7Fqj1154Rf+DVsVeAwdovU2iHZHy6/Bzta';
AWS.config.update({
